...
const LearningOptions = () => {
    ...
    <div className="relative min-h-screen flex items-center justify-center bg-black ">
        <img src="src\assets\learinigOption.png" className="absolute inset-0 w-full h-full object-cover"/>
      <h1 className="text-white text-5xl font-bold mb-10">
        Choose What to Learn!
      </h1>
      <div className="grid grid-cols-2 gap-10 absolute">
        <button className="bg-yellow-500 text-3xl text-white py-4 px-8 rounded-lg hover:bg-yellow-600 transition duration-300" onClick={() => navigate("/learn/A") }>
          Alphabets
        </button>
